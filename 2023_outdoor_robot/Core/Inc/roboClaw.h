...
enum {M1FORWARD = 0,
			...
			SETM1EDFAULTSPEED = 70,
			SETM2EDFAULTSPEED = 71,
			SETPINFUNCTIONS = 74,
			GETPINFUNCTIONS = 75,
			SETDEADBAND	= 76,
			GETDEADBAND	= 77,
			...
			SETCONFIG = 98,
			GETCONFIG = 99,
			DRIVEM1WITHPOSITION = 119,
			DRIVEM2WITHPOSITION = 120,
			DRIVEM1M2WITHPOSITION = 121,
			M1SPEEDPOSITION = 122,
			M2SPEEDPOSITION = 123,
			M1M2SPEEDPOSITION = 124,
			SETM1MAXCURRENT = 133,
			SETM2MAXCURRENT = 134,
			GETM1MAXCURRENT = 135,
			GETM2MAXCURRENT = 136,
...
void L_Forward();
void L_Right(float L_angle);
void L_Left(float L_angle);
void L_turn(float L_angle);

void ResetEnc();
void B_Forward(float B_distance);
void B_Right(float B_angle);
void B_Left(float B_angle);
void B_turn(float B_angle);
